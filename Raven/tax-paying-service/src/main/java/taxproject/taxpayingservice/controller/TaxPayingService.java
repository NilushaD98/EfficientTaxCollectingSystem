    ...
    public RemoteFunctionCall<Tuple6<List,List,List,List,List,List>> getAllPaymentDetailsByNIC(String nic) {
        ...
        return new RemoteFunctionCall<Tuple6<List,List,List,List,List,List>>(
            ...
            public Tuple6<List,List,List,List,List,List> call() throws Exception {
                ...
                DynamicArray<Utf8String> array3 = (DynamicArray<Utf8String>) results.get(1);
                DynamicArray<Utf8String> array4 = (DynamicArray<Utf8String>) results.get(1);
                DynamicArray<Uint> array5 = (DynamicArray<Uint>) results.get(1);
                DynamicArray<Utf8String> array6 = (DynamicArray<Utf8String>) results.get(1);
